...
export default function SubmitDocument() {
  ...
  return (
    <Layout title="Kirim Dokumen">
      <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Kirim Dokumen Baru</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 rounded-2xl p-6 space-y-5 shadow-sm dark:shadow-none">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {errors.document_date && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.document_date}</p>}
            </div>
            <div>
              ...
              {errors.origin_country && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.origin_country}</p>}
            </div>
          </div>
          ...
          <div>
            ...
            {errors.goods_type && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.goods_type}</p>}
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-2">
              ...
              {errors.goods_value && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.goods_value}</p>}
            </div>
            <div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">File Dokumen (PDF/JPG/PNG, maks 10MB)</label>
            <input type="file" multiple accept=".pdf,.jpg,.jpeg,.png" onChange={handleFiles} className="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-indigo-600 file:text-white hover:file:bg-indigo-700 cursor-pointer" required />
            {errors.files && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.files}</p>}
            {errors['files.0'] && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors['files.0']}</p>}
            {fileNames.length > 0 && (
          ...
          <button type="submit" disabled={processing} className="w-full py-3 px-4 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700 disabled:opacity-50 transition-colors cursor-pointer">
